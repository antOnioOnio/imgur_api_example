...
class CustomSearchDelegate extends SearchDelegate<DataEntity?> {
          ...
          return state.dataEntityListSearched.isNotEmpty
              ? ImageListTile(
                  ...
                  onFavoritePressed: (dataEntity) {
                    handleFavorite(context, dataEntity);
                  },
                )
  ...
  void handleFavorite(BuildContext context, DataEntity dataEntity) {
    bloc.add(SearchDelegateEvent.handleFavoritePressed(dataEntity: dataEntity));
