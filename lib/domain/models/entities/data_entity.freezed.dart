...
class _$DataEntityImpl implements _DataEntity {
  ...
  @override
  String toString() {
    return 'DataEntity(id: $id, title: $title, description: $description, datetime: $datetime, cover: $cover, coverWidth: $coverWidth, coverHeight: $coverHeight, accountUrl: $accountUrl, accountId: $accountId, privacy: $privacy, layout: $layout, views: $views, link: $link, ups: $ups, downs: $downs, points: $points, score: $score, isAlbum: $isAlbum, vote: $vote, favorite: $favorite, nsfw: $nsfw, section: $section, commentCount: $commentCount, favoriteCount: $favoriteCount, topic: $topic, topicId: $topicId, imagesCount: $imagesCount, inGallery: $inGallery, isAd: $isAd, tags: $tags, adType: $adType, adUrl: $adUrl, inMostViral: $inMostViral, includeAlbumAds: $includeAlbumAds, images: $images, adConfig: $adConfig)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.includeAlbumAds, includeAlbumAds) ||
                other.includeAlbumAds == includeAlbumAds) &&
