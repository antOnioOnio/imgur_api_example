...
class _$ResponseEntityImpl implements _ResponseEntity {
  _$ResponseEntityImpl({required final List<DataEntity> data}) : _data = data;
...
abstract class _ResponseEntity implements ResponseEntity {
  factory _ResponseEntity({required final List<DataEntity> data}) =
